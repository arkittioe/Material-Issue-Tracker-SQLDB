...
def resolve_base_url():
    #  # از ENV بخوان؛ اگر نبود، از مقدار پیش‌فرض استفاده کن
    #  # مثال ENV:  MIV_API_BASE=http://192.168.1.50:5000
    url = os.getenv("MIV_API_BASE", "").strip().rstrip("/")
    if not url:
        #  # دیفالت لوکال برای توسعه
        url = "http://127.0.0.1:5000"
    #  # اگر Proxy داخلی دارید که روی لوکال مشکل می‌سازد، NO_PROXY را ست کنید
    os.environ.setdefault("NO_PROXY", "127.0.0.1,localhost")
    return url

#  # جایی که قبلاً BASE_URL = "..."
